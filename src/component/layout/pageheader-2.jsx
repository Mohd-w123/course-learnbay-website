...
const title = "Advanced Data Science and AI Program with Domain Specialization";
const desc = "With new capstone projects, learn how to apply your previous domain expertise to make a successful transition.";
